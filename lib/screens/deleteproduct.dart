...
class _DeleteProductState extends State<DeleteProduct> {
  ...
  Future update_product_price() async{
    ...
    var response = await http.post(Uri.https('adeoropelumi.com', 'vendor/vendorupdateproductprice.php'),
        body: {
  ...
  Future update_product_description() async{
    ...
    try{
      var response = await http.post(Uri.https('adeoropelumi.com', 'vendor/vendorupdatedescription.php'),
          body: {
            'pidname':widget.pidname,
  ...
  Future update_product_payment_option() async{
    ...
    try{
      var response = await http.post(Uri.https('adeoropelumi.com', 'vendor/vendorproductupdatepaymentoption.php'),
          body: {
            'pidname':widget.pidname,
                  ...
                  children: [
                    ...
                    if(_selectedItem == 0)...[
                      ...
                      Container(
                        ...
                        child: Text(modify(widget.productdescription),style: TextStyle(
