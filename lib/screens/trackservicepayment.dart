            ...
            children: [
              ...
              Flexible(
                ...
                children: [
                  ...
                  //         builder: (context) {
                  //           return AlertDialog(
                  //             title: Center(child: Text('N'+'${widget.amount}'.replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},'),)),
                  //             content: Text('Are you sure want to release the service payment?',textAlign: TextAlign.center,),
                  ...
                  //                             color: widget.status == 'pending'?Color.fromRGBO(246, 123, 55, 1):
                  //                             Colors.grey
                  //                         ),
                  ...
                  //   },
                  //   child: Container(
                  //     margin: EdgeInsets.only(left: 10,right: 10,top: 30).r,
                  ...
                  //       "Release service payment":
                  //         "Service payment is released",style: TextStyle(
                  //           color: Colors.white,
                  //           fontSize: 15.sp
                  //       ),),
                  //     ),
                  ...
                  //   },
                  //   child: Container(
                  //     margin: EdgeInsets.only(left: 10,right: 10,top: 10,bottom: 0).r,
                  //     padding: EdgeInsets.symmetric(vertical: 20).r,
                  //     decoration: BoxDecoration(
                  ...
                  //       "Request refund":
                  //         "Processing refund",style: TextStyle(
                  //           color: Colors.white,
                  //           fontSize: 15.sp
                  //       ),),
                  //     ),
