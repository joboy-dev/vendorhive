                      ...
                      delegate: SliverChildBuilderDelegate(
                          (context,index){
                            return Container(
                              ...
                              child: Center(
                                  child: Text("Select a Delivery Method for Each Products",style: TextStyle(
                                              ...
                                              onChanged: (value) {
                                                setState(() {
                                                  ...
                                                  for (int i = 0; i < splitNames.length; i++){
                                                    print(splitNames[i]);
                                                    deliveryItems[index].deliveryprice = splitNames[0];
                                                    deliveryItems[index].deliverydays = splitNames[1];
                                                    deliveryItems[index].deliveryplan = splitNames[2];
                                                  }
                                                  print("====================");
                                                  print(deliveryItems[index].pidname);
                                                  print(deliveryItems[index].deliveryplan);
                                                  print(deliveryItems[index].deliveryprice);
                                                  print(deliveryItems[index].deliverydays);
                                                  print("====================");
                                                });
                                              },
                                              icon: Padding(
