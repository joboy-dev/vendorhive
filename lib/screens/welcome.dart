...
class Welcome extends StatefulWidget {
  ...
  Welcome({required this.idname, required this.useremail,
    ...
    if(chatcontact.statusCode == 200){
      ...
      for(int o =0; o<appcontactlist.length; o++){
        ...
        final unread = await http.post(
            Uri.https('adeoropelumi.com','vendor/vendorgetnumberofunreadcust.php'),
            body: {
              'sidname':appcontactlist[o],
            }
        );
                            ...
                            child: GridView.builder(
                                ...
                                itemBuilder: (ctx, index){
                                  return GestureDetector(
                                    onTap: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (context){
                                        return ViewProduct(name: rawproduct[index]['productname'],
                                          amount: rawproduct[index]['productprice'],
                                          imagename: rawproduct[index]['productimg'],
                                          description: rawproduct[index]['productdescription'],
                                          idname: widget.idname,
                                          useremail: widget.useremail,
                                          usertype: widget.usertype,
                                          packagename: widget.packagename,
                                          prodid: rawproduct[index]['pidname'],
                                          adminemail: rawproduct[index]['useremail'],
                                          deliveryprice: double.parse(rawproduct[index]['deliveryprice']),
                                          location: rawproduct[index]['location'],
                                ...
                                itemBuilder: (ctx, index){
                                  return GestureDetector(
                                    onTap: (){
                                      print(index);
                                      Navigator.push(context, MaterialPageRoute(builder: (context){
                                        return ViewService(name: rawservice[index]['name'],
                                          amount: rawservice[index]['price'],
                                          imagename: rawservice[index]['serviceimg'],
                                          description: rawservice[index]['desription'],
                                          idname: widget.idname,
                                          useremail: widget.useremail,
                                          usertype: widget.usertype,
                                          packagename: widget.packagename,
                                          serviceid: rawservice[index]['sidname'],
                                          adminemail: rawservice[index]['useremail'],);
                                      }));
                                    },
                                    child: Container(
                                      margin: EdgeInsets.only(bottom: 10,),
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Container(
                                                        child: RichText(
                                                          text: TextSpan(
                                                              text: "₦"+"$finalquantity".replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},'),style: TextStyle(
                                                              color: Colors.grey,
                                                              fontWeight: FontWeight.w500,
                                                              fontSize: 14
                                                          ),
                                                ...
                                                children: [
                                                  ...
                                                  Expanded(
                                                    child: Align(
                                                      ...
                                                      child: Container(
                                                        child: Text("₦"+"${totalsum}".replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},'),style: TextStyle(
                                                            color: Colors.grey,
                                                            fontSize: 12
                                                        ),),
                                                      ),
                                                ...
                                                children: [
                                                  ...
                                                  Expanded(
                                                    child: Align(
                                                      alignment:Alignment.centerRight,
                                                      child: Container(
                                                        child: Text("₦"+"${totalsumplusdelivery}".replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]},'),
                                                          style: TextStyle(
                                                              color: Colors.black,
                                                              fontSize: 12,
                                                              fontWeight: FontWeight.w500
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                          ...
                                          child: Container(
                                            ...
                                            child: Row(
                                              children: [
                                                Expanded(child: Text("Pay Vendor",
                                                  textAlign: TextAlign.center,
                                                  style: TextStyle(
                                                    color: Colors.white,
                                                    fontWeight: FontWeight.bold,
