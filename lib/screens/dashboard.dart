  ...
  Future getPackage() async{
    ...
    //if vendor package is not free
      ...
      if(diff.inDays <= 0){
        ...
        var deactivate_all_product = await http.post(
        ...
        var deactivate_all_services = await http.post(
        ...
        var activate_5_free_product = await http.post(
        ...
        final activate_5_free_service = await http.post(
